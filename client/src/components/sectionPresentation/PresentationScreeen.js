      ...
      <div className="col-md-12">
        <div className="p-4 border-color text-cont-secondary rounded-3">
          ...
          <div className="row flex-direction-column justify-content-center">
            <img
              className=" rounded  py-lg-3 img-thumbnail col-lg-2 col-md-5 col-sm-8"
              src="/assets/img/perfil.jpg"
              alt="Foto"
            />
            <p className="col-lg-10 col-md-7 col-sm-12 py-lg-3">
            ...
            <p>
              ...
              blockages in different areas of your life.
              <br />
              <br /> This method reprograms and transforms the genealogy of the
              soul, family and individual karma into current, ancestral memories
              of the mental, emotional, physical and spiritual body in all
              dimensions of being.
            </p>
          </div>
        </div>
